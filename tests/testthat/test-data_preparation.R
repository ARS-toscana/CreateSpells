test_that("replace_missing_end_date functionality (and Warning 01)", {
  expect_warning(suppressMessages(test_data_preparation(~person_id, ~op_start_date,  ~op_end_date,
                                                        ...
                                                        "a",  "20100101",         NA)),
                 regexp = "Warning 01")
  expect_warning(suppressMessages(test_data_preparation_special_names(~person_id, ~start_date,  ~end_date,
                                                          "a",  "20100101", "20200101",
                                                          "a",  "20100101",         NA)),
                 regexp = "Warning 01")
  ...
  expect_identical(suppressMessages(test_data_preparation(~person_id, ~op_start_date,  ~op_end_date,
                   ...
                   row_wise_dt(~person_id,~op_start_date,~op_end_date,
                               "a", "20100101","20200101",
                               "a", "20100101","20150101"))
  expect_identical(suppressMessages(test_data_preparation_special_names(~id, ~start_date,  ~end_date,
                                                            "a",  "20100101", "20200101",
                                                            "a",  "20100101",         NA,
                                                            replace_missing_end_date = 20150101)),
