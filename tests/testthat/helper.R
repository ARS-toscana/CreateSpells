...
test_error_type_3 <- function(dataset = test_data_special_names, id = "id", start_date = "start_date",
...
test_error_type_2 <- function(dataset = test_data_overlap, id = "person_id", start_date = "op_start_date",
...
test_error_type_4 <- function(dataset = test_data_overlap_special_names, id = "id", start_date = "start_date", end_date = "end_date",
...
expect_no_error_with_defaults_3 <- function(dataset = test_data_special_names, id = "id", start_date = "start_date",
                                            end_date = "end_date", category = NULL, replace_missing_end_date = NULL,
                                            overlap = F, dataset_overlap = NA_character_, only_overlaps = F,
                                            gap_allowed = 1) {
  expect_no_error(sanitize_inputs(dataset = dataset, id = id, start_date = start_date, end_date = end_date,
...
expect_no_error_with_defaults_2 <- function(dataset = test_data_overlap, id = "person_id", start_date = "op_start_date",
...
expect_no_error_with_defaults_4 <- function(dataset = test_data_overlap_special_names, id = "id", start_date = "start_date",
